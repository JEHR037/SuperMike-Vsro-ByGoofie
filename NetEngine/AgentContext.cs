...
namespace ExploitFilter.NetEngine
{
    sealed class AgentContext
    {
        ...
        */
        ...
        int cape_num = 0;
        bool party = false;
        bool cape_time = false;
        bool Capa_logic = false;
        uint code1 = 0;
        uint code2 = 0;
                    ...
                    if (nReceived != 0)
                    {
                        ...
                        if (RemotePackets != null)
                        {
                            foreach (Packet _pck in RemotePackets)
                            {
                                ...
                                {
                                    _pck.Lock();
                                    this.code1 = _pck.ReadUInt8();
                                    this.code2 = _pck.ReadUInt8();
                                    try
                                    {
                                        if ((this.code1 == 0x18) && (this.code2 == 0x80))
                                        {
                                            cape_time = true;
                                        }
                                        else
                                ...
                                if ((_pck.Opcode == 0xB074) && (_pck.ReadUInt8() == 0x03) && (cape_time == true))
                                {
                                    _pck.Lock();
                                    Send(false);
                                    continue;
                                }
                                if ((_pck.Opcode == 0x3042) && (cape_time == true))
                                {
                                    _pck.Lock();
                                    Send(false);
                                    continue;
                                }
                                if ((_pck.Opcode == 0xB516) && (cape_time == true) && (_pck.ReadUInt8() == 0x02))
                                {
                                    _pck.Lock();
                                    Send(false);
                                    continue;
                                }
                                if ((_pck.Opcode == 0xB074) && (cape_time == true))
                                {
                                    _pck.Lock();
                                    Send(false);
                                    continue;
                                }
                                if ((_pck.Opcode == 0xB50E) && (cape_time == true))
                                {
                                    _pck.Lock();
                                    Send(false);
                                    continue;
                                ...
                                //madafukasc
                                #region Main Action with PvP Loading 
                                if (_pck.Opcode == 0xB070 && (LastestRegion == (-32744)))
                                {
                                    try
                                    {
                                        //_pck.Lock(); // Lock
                                        ...
                                        if (data1 == 0x01 && data2 == 0x00 && data3 == 0x30)
                                        {
                                            ...
                                            if ((cape_time == true) && (!FilterMain.AllowSkillsInPvP.Contains((Int32)SkillID)))
                                            {
                                                    SkillID = 65034;
                                                    continue;
                                            }
                                        ...
                                        if (flag == 0x01)
                                        {
                                            //NO se que coño es este byte pero es 0x0 en buff
                                        }
                                    }
                                    catch { }
                                }
                    ...
                    if (nReceived != 0)
                    {
                        ...
                        if (ReceivedPackets != null)
                        {
                            foreach (Packet _pck in ReceivedPackets)
                            {
                                        ...
                                        if (num == 1 || num == 4)
                                        {
                                            try
                                            {
                                                ...
                                                else
                                                {
                                                    if ((cape_time == true) && (!FilterMain.AllowSkillsInPvP.Contains((Int32)SkillID)))
                                                    {
                                                            SkillID = 65034; //ushort max for avoid cancel autoattacks after Cape true
                                                            TargetID = 0;
                                                            this.SendNotice("You can not Attack/Buff while PvP Loading.");
                                                    }
                                                    else
                                                    { 
                                ...
                                #region Welcome NOtice
                                if (_pck.Opcode == 0x3012)
                                {

                                    if ((!this.startnotice) && (FilterMain.WelcomeMsg))
                                    {
                                        // Disconnect botters.
                                ...
                                if (cape_time == true)
                                {
                                    Packet p1 = new Packet(0x7516);
                                    p1.WriteUInt8(0x05);
                                    m_RemoteSecurity.Send(p1);
                                }
                                #endregion
