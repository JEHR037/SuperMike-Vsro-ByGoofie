...
namespace ExploitFilter
{
    sealed class FilterMain
    {
        ...
        public static string SHA_DB = "SHARD_DB";
        public static string LOG_DB = "DB_LOG";
        ...
        // [PVP] \\
        public static bool PVP_DUEL = true;
        ...
        public static List<int> AllowSkillsInPvP = new List<int>();
